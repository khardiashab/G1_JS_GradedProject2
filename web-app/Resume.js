...
class Resume {
    ...
    displayResume() {
        ...
        if (header.imgUrl == "") {
            ...
            imgSectionElement.innerHTML =
                `<img src=${header.imgUrl} alt="user image"/>`
        }
        ...
        for (const key in workExpersience) {
            if (Object.hasOwnProperty.call(workExpersience, key)) {
                workElement.appendChild(document.createElement("p")).append(
        ...
        projectElement.appendChild(document.createElement("p")).append(
            ...
            if (Object.hasOwnProperty.call(education, key)) {
                ...
                for (const k in education[key]) {
                    if (Object.hasOwnProperty.call(education[key], k)) {
                        p.appendChild(this.getTextNode(education[key][k] + ", "))
